...
/**
 * leads.nearwork.co — the Command Center (Byron 2026-08-08 remodel; this replaced
 * the old LeadsClient page entirely).
 *
 * It reads the SAME `leads` table the 3 AM routine writes, so a rep always sees
 * the live pipeline — there is no copy of the data and no sync step.
 */
