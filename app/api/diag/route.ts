...
export async function GET(req: Request) {
  ...
  try {
    ...
    const compact = all
      ...
      .map((l: any) => ({ company: l.company, owner: l.owner, status: l.status, sent_count: l.sent_count, last_activity: l.last_activity, email: l.email, role: l.role, first_name: l.first_name, source: l.source, opened: l.opened, ab_variant: l.ab_variant, lead_date: l.lead_date, gen_subject: l.gen_subject, has_gen_body: !!l.gen_body, sprint_name: l.sprint_name, has_steps: !!(l.steps && l.steps.length), has_body_tpl: !!l.body_tpl }));
